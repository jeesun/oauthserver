...
CREATE TABLE t_s_side_menu_multi_languages (
	...
	side_menu_id bigint(20) NOT NULL COMMENT '侧边栏菜单id',
	name varchar(255) COMMENT '侧边栏菜单名称',
    language varchar(25) NOT NULL COMMENT '语言'
) COMMENT '侧边栏菜单多语言';
...
CREATE TABLE t_s_dict_type_group_multi_languages (
  ...
  update_by bigint(20) DEFAULT NULL COMMENT '更新人id',
  update_date datetime DEFAULT NULL COMMENT '更新时间',
	dict_type_group_id bigint(20) NOT NULL COMMENT '字典组id',
	name varchar(255) COMMENT '字典组名称',
  language varchar(25) NOT NULL COMMENT '语言'
) COMMENT '字典组多语言';
...
CREATE TABLE t_s_dict_type_multi_languages (
  ...
  update_by bigint(20) DEFAULT NULL COMMENT '更新人id',
  update_date datetime DEFAULT NULL COMMENT '更新时间',
	dict_type_id bigint(20) NOT NULL COMMENT '字典id',
...
alter table t_s_dict_type_multi_languages RENAME t_s_dt_multi_languages;
alter table t_s_dict_type_group_multi_languages RENAME t_s_dtg_multi_languages;
-- 重建视图
