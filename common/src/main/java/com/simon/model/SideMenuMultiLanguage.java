...
* @date 2019-05-30
**/
@ApiModel(description = "侧边栏菜单多语言")
@Data
@EqualsAndHashCode(callSuper = false)
@Entity
@Table(name="t_s_side_menu_multi_languages")
public class SideMenuMultiLanguage implements Serializable{
