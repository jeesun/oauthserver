...
4. 集成Mybatis，以及插件：通用Mapper，PageHelper；
...
8. 代码生成器，运行`com/simon/common/code/CodeGenerator.java`的main方法进行代码生成，代码生成器的配置在`code-gen.properties`。可生成Model、Mapper、Repository、Service、ServiceImpl、Controller。
...
**更多历史更新日志查看[CHANGE_LOG.md](CHANGE_LOG.md)**
